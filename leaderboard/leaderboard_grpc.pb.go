...
type LeaderboardClient interface {
	GetLeaderboard(ctx context.Context, in *Player, opts ...grpc.CallOption) (*List, error)
}
...
func (c *leaderboardClient) GetLeaderboard(ctx context.Context, in *Player, opts ...grpc.CallOption) (*List, error) {
	out := new(List)
	err := c.cc.Invoke(ctx, "/Leaderboard/GetLeaderboard", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LeaderboardServer interface {
	GetLeaderboard(context.Context, *Player) (*List, error)
...
func (UnimplementedLeaderboardServer) GetLeaderboard(context.Context, *Player) (*List, error) {
...
func _Leaderboard_GetLeaderboard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Leaderboard/GetLeaderboard",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LeaderboardServer).GetLeaderboard(ctx, req.(*Player))
	}
